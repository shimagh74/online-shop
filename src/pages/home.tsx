    ...
    return (
        <>
            ...
            <div className='md:w-10/12 w-full grid grid-cols-3 gap-3 px-3 md:gap-6 mx-auto justify-center py-9'>
                <div className='border border-red-400 rounded-sm px-3 py-6 flex justify-center items-center sm:gap-5'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-12 h-12 object-contain hidden sm:block text-red-500">
                ...
                <div className='border border-red-400 rounded-sm px-3 py-6 flex justify-center items-center sm:gap-5'>
                    <BiSupport className="w-12 h-12 object-contain text-red-500 hidden sm:block" />
                    <div >
