      ...
      <div className="md:flex md:flex-row md:justify-between items-center text-center py-4 md:px-12 md:py-4
       fixed top-0 left-0 right-0 z-20 bg-white border-b-2">
        ...
        <div className="mt-2 ">
          ...
          <Link to="/cart"
            className="bg-gradient-to-r from-red-600 to-pink-600 text-gray-50 hover:from-pink-600 hover:to-pink-600  p-3 px-5 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 inline-block">
